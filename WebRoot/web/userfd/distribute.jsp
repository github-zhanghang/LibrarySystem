		...
		<div class="right_2">
			<div class="right_nr">
				<div class="right_title">
					<span style="float:left;"><strong>馆藏分布</strong>Distribute</span>
					<div class="clear"></div>
				</div>
				<div class="case_right_box">
					<div class="yc_intro_list fl">
						<h3>人文历史</h3>
						<div class="yc_ib_img">
							<img src="images/za.jpg" alt="" width="287" height="106" />
						</div>
						<div class="yc_ib_list">
							<ul>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=114042&ctlgid=154482">2楼</a></li>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=113639&ctlgid=154482">H I J</a></li>

							</ul>
						</div>
						<span class="intro_more"><a target="_blank"
							href="/zjyc/rwls/">更多</a> </span>
					</div>
					<div class="yc_intro_list fl">
						<h3>综合</h3>
						<div class="yc_ib_img">
							<img src="images/zb.jpg" alt="" width="287" height="106" />
						</div>
						<div class="yc_ib_list">
							<ul>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=102924&ctlgid=624323">4楼</a></li>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=102926&ctlgid=624323">A-Z</a></li>

							</ul>
						</div>
						<span class="intro_more"><a target="_blank"
							href="/zjyc/mfms/">更多</a> </span>
					</div>
					<div class="yc_intro_list fl">
						<h3>社会科学</h3>
						<div class="yc_ib_img">
							<img src="images/ze.jpg" alt="" width="287" height="106" />
						</div>
						<div class="yc_ib_list">
							<ul>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=112873&ctlgid=413752">5楼北</a></li>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=112770&ctlgid=413752">F</a></li>

							</ul>
						</div>
						<span class="intro_more"><a target="_blank"
							href="/zjyc/jjfz/">更多</a> </span>
					</div>
					<div class="yc_intro_list fl">
						<h3>自然科学</h3>
						<div class="yc_ib_img">
							<img src="images/zc.jpg" alt="" width="287" height="106" />
						</div>
						<div class="yc_ib_list">
							<ul>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=112873&ctlgid=413752">5楼南</a></li>
								<li><a target="_blank"
									href="/showxxgk.aspx?Id=112770&ctlgid=413752">ABCDEGK</a></li>
							</ul>
						</div>
						<span class="intro_more"><a target="_blank"
							href="/zjyc/dlhj/">更多</a> </span>
					</div>
				</div>
		</div>
		</div>
