...
<body style="background-color:#fff;">
	<div class="header bg-main">
		<div class="logo margin-big-left fadein-top">
			<h1>
				<img src="images/zc.jpg" class="radius-circle rotate-hover"
					height="50" width="50" alt="" />图书馆后台管理中心
			</h1>
		</div>
		<div class="head-l">
			<a class="button button-little bg-green" href="../userfd/index.jsp"
				target="_blank"><span class="icon-home"></span> 用户首页</a>
			&nbsp;&nbsp;<a class="button button-little bg-red"
				href="../userfd/login.jsp"><span class="icon-power-off"></span>
				退出登录</a>
		</div>
	</div>
	<div class="leftnav">
