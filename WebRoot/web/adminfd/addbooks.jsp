...
<body>
	...
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong><span class="icon-key"></span> 新书入库</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x"
				action="<%=request.getContextPath()%>/addBookServlet" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="author" size="50"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="press"
				...
				<div class="form-group">
					...
					<div id="localImage">
						  <img style="margin-left:150px;background: #f0f;" id="preview"
							width=-1 height=-1 /> 
					</div>
				</div>
